...
public class Menu {                                     // Menu en Java
    public static void main(String[] args) {
        ...
        File directory = new File("C:\\Users\\kheir\\IdeaProjects\\Java-School-TP\\Java-TP1\\src");        // Je commence par déterminer le dossier que je veux choisir
        int fileCount = (directory.list().length - 1);      // ensuite je compte combien j'ai de fichiers dans mon dossier
        System.out.println(fileCount);                                                // Je fais -1 pour qu'il ne prennent pas en compte le Menu
