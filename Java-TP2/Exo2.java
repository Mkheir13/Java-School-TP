...
public class Exo2 {
    ...
    public static double MesImpots(double gains, boolean isFucking, double MoneySuckers) {         //Création de la méthode MesImpots
        ...
        if (isFucking) diviseur = 2 + (MoneySuckers / 2);     //On vérifie si l'utilisateur est marié
        else if (MoneySuckers > 0) {                        //On vérifie si l'utilisateur a des enfants
            diviseur += MoneySuckers / 2;                     //On divise le salaire par le nombre d'enfants
